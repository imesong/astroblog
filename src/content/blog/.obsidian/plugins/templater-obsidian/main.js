...
function Ui(r) {
  r = (0, Ie.normalizePath)(r);
  let e = app.vault.getAbstractFileByPath(r);
  if (!e) throw new w(`Folder "${r}" doesn't exist`);
  if (!(e instanceof Ie.TFolder)) throw new w(`${r} is a file, not a folder`);
  return e;
}
function at(r) {
  r = (0, Ie.normalizePath)(r);
  ...
  if (!(e instanceof Ie.TFile)) throw new w(`${r} is a folder, not a file`);
  return e;
}
function Ce(r) {
  let e = Ui(r),
    t = [];
  return (
    Ie.Vault.recurseChildren(e, n => {
      n instanceof Ie.TFile && t.push(n);
    }),
...
var ti = G(require("obsidian"));
var Zn = G(require("obsidian"));
var W = "top",
  Z = "bottom",
  Q = "right",
  U = "left",
  ...
  lr = [].concat(Ze, [sr]).reduce(function (r, e) {
...
function je(r, e, t) {
  ...
  var l = he(r) ? Y(r) : window,
    A = l.visualViewport,
    p = !St() && t,
    g = (n.left + (p && A ? A.offsetLeft : 0)) / o,
    f = (n.top + (p && A ? A.offsetTop : 0)) / s,
    b = n.width / o,
    k = n.height / s;
  return {
    width: b,
...
function Ue(r) {
  return te(r) === "html"
    ? r
    : r.assignedSlot || r.parentNode || (Et(r) ? r.host : null) || ne(r);
}
function Sn(r) {
...
function so(r) {
  ...
  var o = Ue(r);
  for (Et(o) && (o = o.host); ee(o) && ["html", "body"].indexOf(te(o)) < 0; ) {
    var s = Ae(o);
    if (
      s.transform !== "none" ||
      s.perspective !== "none" ||
...
function Ee(r) {
  for (var e = Y(r), t = Sn(r); t && kr(t) && Ae(t).position === "static"; )
    t = Sn(t);
  return t &&
...
function lo(r) {
  var e,
    ...
    f = g ? "height" : "width";
  if (!(!s || !l)) {
    var b = ao(o.padding, t),
      k = At(s),
      x = p === "y" ? W : U,
      q = p === "y" ? Z : Q,
      P =
        t.rects.reference[f] + t.rects.reference[p] - l[p] - t.rects.popper[f],
      j = l[p] - t.rects.reference[p],
      B = Ee(s),
      L = B ? (p === "y" ? B.clientHeight || 0 : B.clientWidth || 0) : 0,
      N = P / 2 - j / 2,
      T = b[x],
      C = L - k[f] - b[q],
      I = L / 2 - k[f] / 2 + N,
      R = mt(T, I, C),
      z = p;
    t.modifiersData[n] = ((e = {}), (e[z] = R), (e.centerOffset = R - I), e);
  }
}
function co(r) {
  var e = r.state,
...
function Nn(r) {
  ...
  if (g) {
    ...
    if (
      ...
      T = Z;
      var J = b && I === C && C.visualViewport ? C.visualViewport.height : I[R];
      (P -= J - n.height), (P *= p ? 1 : -1);
    }
    if (o === U || ((o === W || o === Z) && s === ct)) {
      N = Q;
      var V = b && I === C && C.visualViewport ? C.visualViewport.width : I[z];
      (x -= V - n.width), (x *= p ? 1 : -1);
    }
  }
  var m = Object.assign({ position: A }, g && po),
    h = f === !0 ? Ao({ x, y: P }, Y(t)) : { x, y: P };
  if (((x = h.x), (P = h.y), p)) {
    var c;
...
function mo(r) {
  ...
  return (
    ...
    A && p.addEventListener("resize", t.update, cr),
    function () {
      s &&
        g.forEach(function (f) {
          f.removeEventListener("scroll", t.update, cr);
        }),
        A && p.removeEventListener("resize", t.update, cr);
    }
  );
}
var Yn = {
...
function dt(r) {
  return je(ne(r)).left + ft(r).scrollLeft;
}
function Tr(r, e) {
  var t = Y(r),
    n = ne(r),
  ...
  if (o) {
    ...
    var g = St();
    (g || (!g && e === "fixed")) && ((A = o.offsetLeft), (p = o.offsetTop));
  }
  return { width: s, height: l, x: A + dt(r), y: p };
}
function Fr(r) {
  var e,
    t = ne(r),
...
function et(r, e) {
  ...
  var n = Ar(r),
    ...
    s = Y(n),
    l = o ? [s].concat(s.visualViewport || [], gt(n) ? n : []) : n,
    A = e.concat(l);
  return o ? A : A.concat(et(Ue(l)));
}
function Ft(r) {
...
function Ln(r, e, t) {
  return e === ar ? Ft(Tr(r, t)) : he(e) ? ho(e, t) : Ft(Fr(ne(r)));
}
function jo(r) {
  var e = et(Ue(r)),
  ...
  return he(n)
    ? e.filter(function (o) {
        return he(o) && Dt(o, n) && te(o) !== "body";
      })
    : [];
}
function Mr(r, e, t, n) {
  var o = e === "clippingParents" ? jo(r) : [].concat(e),
    s = [].concat(o, [t]),
    l = s[0],
    A = s.reduce(
      function (p, g) {
        var f = Ln(r, g, n);
        return (
          (p.top = xe(f.top, p.top)),
          (p.right = pt(f.right, p.right)),
          (p.bottom = pt(f.bottom, p.bottom)),
          (p.left = xe(f.left, p.left)),
          p
        );
      },
      Ln(r, l, n)
...
function ke(r, e) {
  ...
  var t = e,
    ...
    P = t.padding,
    j = P === void 0 ? 0 : P,
    B = Nt(typeof j != "number" ? j : Rt(j, Ze)),
    L = k === xt ? qn : xt,
    N = r.rects.popper,
    T = r.elements[q ? L : k],
    C = Mr(he(T) ? T : T.contextElement || ne(r.elements.popper), p, f, l),
    I = je(r.elements.reference),
    R = Yt({ reference: I, element: N, strategy: "absolute", placement: o }),
    z = Ft(Object.assign({}, N, R)),
    J = k === xt ? z : I,
    V = {
      top: C.top - J.top + B.top,
      bottom: J.bottom - C.bottom + B.bottom,
      left: C.left - J.left + B.left,
      right: J.right - C.right + B.right,
    },
...
function Pr(r, e) {
  ...
  var t = e,
    ...
    b = f
      ? A
        ? Er
        : Er.filter(function (q) {
            return _e(q) === f;
          })
      : Ze,
    k = b.filter(function (q) {
      return g.indexOf(q) >= 0;
    });
  k.length === 0 && (k = b);
  var x = k.reduce(function (q, P) {
    return (
      (q[P] = ke(r, { placement: P, boundary: o, rootBoundary: s, padding: l })[
        re(P)
      ]),
      q
    );
  }, {});
  return Object.keys(x).sort(function (q, P) {
    return x[q] - x[P];
  });
}
function _o(r) {
...
function wo(r) {
  var e = r.state,
    ...
    l = ke(e, { elementContext: "reference" }),
...
function bo(r, e, t) {
  ...
  return (
    (l = l || 0),
    (A = (A || 0) * o),
    [U, Q].indexOf(n) >= 0 ? { x: A, y: l } : { x: l, y: A }
  );
}
function yo(r) {
  var e = r.state,
    ...
    o = t.offset,
    s = o === void 0 ? [0, 0] : o,
    l = lr.reduce(function (f, b) {
      return (f[b] = bo(b, e.rects, s)), f;
    }, {}),
    A = l[e.placement],
    p = A.x,
    g = A.y;
...
function Eo(r) {
  var e = r.state,
    ...
    q = t.tetherOffset,
    P = q === void 0 ? 0 : q,
    j = ke(e, { boundary: p, rootBoundary: g, padding: b, altBoundary: f }),
    B = re(e.placement),
    L = _e(e.placement),
    N = !L,
    T = ut(B),
  ...
  if (!!I) {
    if (s) {
      var c,
        ...
        H = _[me],
        Re = mt(0, R[oe], y[oe]),
        S = N ? R[oe] / 2 - jt - Re - F - V.mainAxis : Be - Re - F - V.mainAxis,
        le = N
          ? -R[oe] / 2 + jt + Re + H + V.mainAxis
          : Ne + Re + H + V.mainAxis,
        nt = e.elements.arrow && Ee(e.elements.arrow),
        Kt = nt ? (T === "y" ? nt.clientTop || 0 : nt.clientLeft || 0) : 0,
        Ye = (c = m == null ? void 0 : m[T]) != null ? c : 0,
        Le = se + S - Ye - Kt,
        Je = se + le - Ye,
        it = mt(x ? pt(Pe, Le) : Pe, se, x ? xe(fe, Je) : fe);
      (I[T] = it), (h[T] = it - se);
    }
    if (A) {
      var Ut,
        ...
        Qt = He - j[Jt],
        Ot = [W, U].indexOf(B) !== -1,
        ot = (Ut = m == null ? void 0 : m[C]) != null ? Ut : 0,
        Zt = Ot ? Xt : He - R[_t] - z[_t] - ot + V.altAxis,
        Oe = Ot ? He + R[_t] + z[_t] - ot - V.altAxis : Qt,
        X = x && Ot ? Dn(Zt, He, Oe) : mt(x ? Zt : Xt, He, x ? Oe : Qt);
      (I[C] = X), (h[C] = X - He);
    }
    e.modifiersData[n] = h;
  }
...
function Ir(r, e, t) {
  ...
  return (
    (n || (!n && !t)) &&
      ((te(e) !== "body" || gt(s)) && (A = qr(e)),
      ee(e)
        ? ((p = je(e, !0)), (p.x += e.clientLeft), (p.y += e.clientTop))
        : s && (p.x = dt(s))),
    {
...
function Qn(r) {
  ...
  var e = r,
    ...
    o = e.defaultOptions,
    s = o === void 0 ? Jn : o;
  return function (A, p, g) {
    g === void 0 && (g = s);
    var f = {
        placement: "bottom",
        orderedModifiers: [],
        options: Object.assign({}, Jn, s),
        modifiersData: {},
        elements: { reference: A, popper: p },
        attributes: {},
        styles: {},
      },
      b = [],
      ...
      x = {
        ...
        setOptions: function (B) {
          var L = typeof B == "function" ? B(f.options) : B;
          P(),
          ...
          var N = Cr(Dr([].concat(n, f.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!k) {
            ...
            if (!!Xn(L, N)) {
              (f.rects = {
                reference: Ir(L, Ee(N), f.options.strategy === "fixed"),
                popper: At(N),
              }),
                (f.reset = !1),
              ...
              for (var T = 0; T < f.orderedModifiers.length; T++) {
                ...
                var C = f.orderedModifiers[T],
                  I = C.fn,
                  R = C.options,
                  z = R === void 0 ? {} : R,
                  J = C.name;
                typeof I == "function" &&
                  (f = I({ state: f, options: z, name: J, instance: x }) || f);
              }
            }
          }
        },
    ...
    function q() {
      f.orderedModifiers.forEach(function (j) {
        ...
        if (typeof T == "function") {
          var C = T({ state: f, name: B, instance: x, options: N }),
            I = function () {};
          b.push(C || I);
        }
      });
...
var Fo = [Yn, Un, Rn, Cn, Kn, Hn, zn, $n, Wn],
  $r = Qn({ defaultModifiers: Fo });
var Mo = (r, e) => ((r % e) + e) % e,
  ei = class {
    constructor(e, t, n) {
      (this.owner = e),
    ...
    setSelectedItem(e, t) {
      let n = Mo(e, this.suggestions.length),
  ...
  Lt = class {
    constructor(e) {
      ...
      (this.suggest = new ei(this, t, this.scope)),
...
var ni = {
  ...
  Nr = class extends M.PluginSettingTab {
    constructor(e) {
      super(app, e);
      this.plugin = e;
    }
    ...
    add_templates_hotkeys_setting() {
      ...
      e.append("Template hotkeys allows you to bind a template to a hotkey."),
        ...
        this.plugin.settings.enabled_templates_hotkeys.forEach((t, n) => {
          new M.Setting(this.containerEl)
            .addSearch(s => {
              new Mt(s.inputEl, this.plugin, Te.TemplateFiles),
                s
            ...
            .addExtraButton(s => {
              s.setIcon("any-key")
                ...
                .onClick(() => {
                  ...
                  (l.searchComponent.inputEl.value = t),
        ...
        !!this.plugin.settings.enable_folder_templates &&
          (this.plugin.settings.folder_templates.forEach((n, o) => {
            new M.Setting(this.containerEl)
              ...
              .addSearch(l => {
                new Mt(l.inputEl, this.plugin, Te.TemplateFiles),
                  l
            ...
            new M.Setting(this.containerEl)
              .addText(l => {
                l
                  ...
                  l.inputEl.addClass("templater_search");
              })
              .addSearch(l => {
                new Mt(l.inputEl, this.plugin, Te.TemplateFiles),
                  l
              ...
              .addExtraButton(l => {
                l.setIcon("up-chevron-glyph")
                  .setTooltip("Move up")
                  .onClick(() => {
                    lt(this.plugin.settings.file_templates, o, o - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
    ...
    add_user_script_functions_setting() {
      ...
      if (!this.plugin.settings.user_scripts_folder)
        ...
        let n = pe(
          () => Ce(this.plugin.settings.user_scripts_folder),
...
var Rr = class extends ur.FuzzySuggestModal {
  ...
  getItems() {
    ...
    let e = pe(
      () => Ce(this.plugin.settings.templates_folder),
      ...
      return async e => {
        ...
        if (e instanceof ie.TFile) t = await app.vault.read(e);
          ...
          if (((t = await app.vault.read(l)), s)) {
            let A = app.metadataCache.getFileCache(l);
            if (A) {
              let p = (0, ie.resolveSubpath)(A, s);
              p && (t = t.slice(p.start.offset, p.end?.offset));
            }
          }
        }
        try {
...
var Se = G(require("obsidian"));
var Wr = class extends Se.Modal {
  constructor(e, t, n) {
    super(app);
    this.prompt_text = e;
...
var Ur = class extends ue {
  ...
  generate_prompt() {
    return async (e, t, n = !1, o = !1) => {
      let s = new Wr(e, t, o),
        l = new Promise((A, p) => s.openAndGetValue(A, p));
      try {
        return await l;
      } catch (A) {
        if (n) throw A;
  ...
  generate_suggester() {
    return async (e, t, n = !1, o = "", s) => {
      let l = new Kr(e, t, o, s),
        A = new Promise((p, g) => l.openAndGetValue(p, g));
      try {
        return await A;
      } catch (p) {
        if (n) throw p;
  ...
  constructor(e) {
    ...
    !(app.vault.adapter instanceof Gt.FileSystemAdapter)
      ...
      : ((this.cwd = app.vault.adapter.getBasePath()),
        (this.exec_promise = (0, pi.promisify)(ci.exec)));
  }
...
var Qr = class {
  ...
  async load_user_script_function(e, t) {
    let n = p => window.require && window.require(p),
      o = {},
      s = { exports: o },
    ...
    try {
      ...
      throw new w(`Failed to load user script at "${e.path}".`, p.message);
    }
...
function tt(r, e) {
  return Ai.decode(fr().subarray(r, r + e));
}
function rt(r) {
  Vt === Fe.length && Fe.push(Fe.length + 1);
  let e = Vt;
  return (Vt = Fe[e]), (Fe[e] = r), e;
}
var Me = 0,
...
var ht = class {
    ...
    constructor(e, t, n, o, s, l, A) {
      let p = ze(e, v.__wbindgen_malloc, v.__wbindgen_realloc),
        g = Me,
        f = ze(t, v.__wbindgen_malloc, v.__wbindgen_realloc),
        b = Me,
        k = ze(A, v.__wbindgen_malloc, v.__wbindgen_realloc),
        x = Me,
        q = v.parserconfig_new(
          p,
          g,
          f,
          b,
  ...
  Bt = class {
    static __wrap(e) {
      let t = Object.create(Bt.prototype);
      return (t.ptr = e), t;
    }
    __destroy_into_raw() {
      let e = this.ptr;
    ...
    render_content(e, t) {
      try {
        let l = v.__wbindgen_add_to_stack_pointer(-16),
          A = ze(e, v.__wbindgen_malloc, v.__wbindgen_realloc),
          p = Me;
        v.renderer_render_content(l, this.ptr, A, p, Co(t));
        var n = ge()[l / 4 + 0],
          o = ge()[l / 4 + 1],
          s = ge()[l / 4 + 2];
        if (s) throw tn(o);
        ...
        v.__wbindgen_add_to_stack_pointer(16), (Fe[hr++] = void 0);
      }
    }
  };
...
var Wt = class {
  ...
  async create_new_note_from_template(e, t, n, o = !0) {
    ...
    if (
      (e instanceof ve.TFile
        ? ((p = this.create_running_config(e, l, 0)),
          (g = await ye(
            async () => this.read_and_parse_template(p),
            "Template parsing error, aborting."
          )))
        : ((p = this.create_running_config(void 0, l, 0)),
          (g = await ye(
            async () => this.parse_template(p, e),
            "Template parsing error, aborting."
          ))),
      g == null)
    ) {
      await app.vault.delete(l), await this.end_templater_task(A);
      return;
    }
    if (
    ...
    return await this.end_templater_task(A), l;
  }
  async append_template_to_active_file(e) {
    ...
    let p = n.editor.getDoc(),
      g = p.listSelections();
    p.replaceSelection(l),
      ...
      app.workspace.trigger("templater:template-appended", {
        ...
        content: l,
        oldSelections: g,
        newSelections: p.listSelections(),
      }),
      ...
      if (p !== null) {
        ...
        for (; g != null; ) {
          ...
          let k = n.lastIndex - g[0].length,
            x = n.lastIndex;
          (p = p.substring(0, k) + b + p.substring(x)),
  ...
  static async on_file_creation(e, t) {
    ...
    if (
      !(t.path.includes(n) && n !== "/") &&
      (await or(300), !e.files_with_pending_templates.has(t.path))
    )
      if (t.stat.size == 0 && e.plugin.settings.enable_folder_templates) {
        let o = e.get_new_file_template_for_folder(t.parent);
        if (!o) return;
        let s = await ye(async () => at(o), `Couldn't find template ${o}`);
        if (s == null) return;
        await e.write_template_to_file(s, t);
      } else if (t.stat.size == 0 && e.plugin.settings.enable_file_templates) {
        let o = e.get_new_file_template_for_file(t);
        if (!o) return;
        let s = await ye(async () => at(o), `Couldn't find template ${o}`);
        if (s == null) return;
        await e.write_template_to_file(s, t);
  ...
  async execute_startup_scripts() {
    for (let e of this.plugin.settings.startup_templates) {
      if (!e) continue;
      let t = pe(() => at(e), `Couldn't find startup template "${e}"`);
      if (!t) continue;
      let { path: n } = t;
      this.start_templater_task(n);
...
var sn = class {
  ...
  remove_template_hotkey(e) {
    e &&
      (app.commands.removeCommand(`${this.plugin.manifest.id}:create-${e}`),
      app.commands.removeCommand(`${this.plugin.manifest.id}:${e}`));
  }
};
    ...
    if (o) {
      ...
      e.editor.setValue(n),
        s &&
          ...
          (o.forEach(l => {
            s.folds = s.folds.filter(A => A.from > l.line || A.to < l.line);
          }),
...
`,
  ...
  replace_and_get_cursor_positions(e) {
    ...
    t.sort(
      (p, g) =>
        Number(p.groups && p.groups.order) - Number(g.groups && g.groups.order)
    );
    let s = t[0][0];
    t = t.filter(p => p[0] === s);
    let l = [],
...
var cn = class {
  ...
  get_all_functions_documentation(e) {
    if (e === "user") {
      ...
      let t = pe(
        () => Ce(this.settings.user_scripts_folder),
        "User Scripts folder doesn't exist"
      );
      return !t || t.length === 0
        ? void 0
...
var pn = class extends vi.EditorSuggest {
  constructor(e) {
    super(app);
  ...
  onTrigger(e, t, n) {
    ...
    return (this.latest_trigger_info = p), p;
  }
  getSuggestions(e) {
    let t;
    return (
  ...
  r.defineMode("javascript", function (e, t) {
    ...
    function L(i) {
      return function (a, u) {
        ...
        return d || (u.tokenize = B), j("string", "string");
      };
    }
    function N(i, a) {
    ...
    function oe(i, a) {
      if (a)
        if (a.block) {
          var u = oe(i, a.prev);
          return u ? (u == a.prev ? a : new Pe(u, a.vars, !0)) : null;
        } else return we(i, a.vars) ? a : new Pe(a.prev, new fe(i, a.vars), !1);
      else return null;
    }
    function se(i) {
      return (
    ...
    var jt = new fe("this", new fe("arguments", null));
    function Be() {
      (m.state.context = new Pe(m.state.context, m.state.localVars, !1)),
        (m.state.localVars = jt);
    }
    function Ne() {
    ...
    function y(i, a) {
      var u = function () {
        ...
        if (d.lexical.type == "stat") E = d.lexical.indented;
          ...
          for (var O = d.lexical; O && O.type == ")" && O.align; O = O.prev)
            E = O.indented;
    ...
    function Kt(i, a, u) {
      if (m.state.fatArrowAt == m.stream.start) {
        var d = u ? Jt : zt;
        if (i == "(") return c(Be, y(")"), X(st, ")"), _, F("=>"), d, ae);
        if (i == "variable") return h(Be, be, F("=>"), d, ae);
      }
      var E = u ? Je : Le;
    ...
    function Je(i, a, u) {
      var d = u == !1 ? Le : Je,
        E = u == !1 ? S : le;
      if (i == "=>") return c(Be, u ? Jt : zt, ae);
      if (i == "operator")
        return /\+\+|--/.test(a) || (p && a == "!")
          ? c(d)
          : p && a == "<" && m.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
            ? c(y(">"), X(D, ">"), _, d)
            : a == "?"
              ? c(S, F(":"), E)
              : c(E);
      ...
      if (i != ";") {
        if (i == "(") return qt(le, ")", "call", d);
        if (i == ".") return c(Ot, d);
        if (i == "[") return c(y("]"), Ye, F("]"), _, d);
        if (p && a == "as") return (m.marked = "keyword"), c(D, d);
        if (i == "regexp")
          return (
    ...
    function zt(i) {
      return I(m.stream, m.state), h(i == "{" ? H : S);
    }
    function Jt(i) {
      return I(m.stream, m.state), h(i == "{" ? H : le);
    }
    function He(i) {
      return function (a) {
        return a == "."
    ...
    function ot(i, a) {
      ...
      if (i == "variable" || m.style == "keyword") {
        ...
        if (i == "number" || i == "string")
          return (m.marked = s ? "property" : m.style + " property"), c(Oe);
        if (i == "jsonld-keyword") return c(Oe);
        if (p && se(a)) return (m.marked = "keyword"), c(ot);
        if (i == "[") return c(S, vt, F("]"), Oe);
        if (i == "spread") return c(le, Oe);
        if (a == "*") return (m.marked = "keyword"), c(ot);
        if (i == ":") return h(Oe);
      }
    }
    function Zt(i) {
      return i != "variable" ? h(Oe) : ((m.marked = "property"), c(Qe));
    }
    function Oe(i) {
      if (i == ":") return c(le);
      if (i == "(") return h(Qe);
    ...
    function xi(i, a) {
      if (p && (i == ":" || a == "in")) return c(D);
    }
    function gn(i) {
      if (p && i == ":")
        return m.stream.match(/^\s*\w+\s+is\b/, !1) ? c(S, Ei, D) : c(D);
    }
    function Ei(i, a) {
    ...
    function It(i, a) {
      if (i == "variable" || m.style == "keyword")
        return (m.marked = "property"), c(It);
      if (a == "?" || i == "number" || i == "string") return c(It);
      if (i == ":") return c(D);
      if (i == "[") return c(F("variable"), xi, F("]"), It);
      if (i == "(") return h(bt, It);
      if (!i.match(/[;\}\)\],]/)) return c();
    }
    function wr(i, a) {
    ...
    function yr(i, a) {
      return a == "enum" ? ((m.marked = "keyword"), c(xn)) : h(be, vt, Xe, Bi);
    }
    function be(i, a) {
      if (p && se(a)) return (m.marked = "keyword"), c(be);
      if (i == "variable") return me(a), c();
    ...
    function Oi(i) {
      return i == "var" ? c(yr, wt) : i == "variable" ? c(wt) : h(wt);
    }
    function wt(i, a) {
      return i == ")"
        ? c()
        : i == ";"
          ? c(wt)
          : a == "in" || a == "of"
            ? ((m.marked = "keyword"), c(S, wt))
            : h(S, wt);
    }
    function Qe(i, a) {
      if (a == "*") return (m.marked = "keyword"), c(Qe);
      if (i == "variable") return me(a), c(Qe);
      if (i == "(") return c(Be, y(")"), X(st, ")"), _, gn, H, ae);
      if (p && a == "<") return c(y(">"), X(tr, ">"), _, Qe);
    }
    function bt(i, a) {
      if (a == "*") return (m.marked = "keyword"), c(bt);
      if (i == "variable") return me(a), c(bt);
      if (i == "(") return c(Be, y(")"), X(st, ")"), _, gn, ae);
      if (p && a == "<") return c(y(">"), X(tr, ">"), _, bt);
    }
    function vn(i, a) {
    ...
    function wn(i, a) {
      if (i == "variable") return me(a), c(rr);
    }
    function rr(i, a) {
      if (a == "<") return c(y(">"), X(tr, ">"), _, rr);
      if (a == "extends" || a == "implements" || (p && i == ","))
        return a == "implements" && (m.marked = "keyword"), c(p ? D : S, rr);
    ...
    function Ve(i, a) {
      if (
        i == "async" ||
        (i == "variable" &&
          (a == "static" || a == "get" || a == "set" || (p && se(a))) &&
          m.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
      )
        return (m.marked = "keyword"), c(Ve);
      if (i == "variable" || m.style == "keyword")
        return (m.marked = "property"), c(Ct, Ve);
      if (i == "number" || i == "string") return c(Ct, Ve);
      if (i == "[") return c(S, vt, F("]"), Ct, Ve);
      if (a == "*") return (m.marked = "keyword"), c(Ve);
      if (p && i == "(") return h(bt, Ve);
      if (i == ";" || i == ",") return c(Ve);
      if (i == "}") return c();
      if (a == "@") return c(S, Ve);
    }
    ...
    function nr(i, a) {
      return i == "{"
        ? qt(nr, "}")
        : (i == "variable" && me(a), a == "*" && (m.marked = "keyword"), c(Si));
    }
    function yn(i) {
      if (i == ",") return c(nr, yn);
    }
    ...
    function xr(i, a) {
      if (a == "from") return (m.marked = "keyword"), c(S);
    }
    function Di(i) {
      return i == "]" ? c() : h(X(le, "]"));
    }
          ...
          : ce == "form" && u == "{"
            ...
            : ce == "form"
              ...
              : ce == "stat"
                ...
                : d.info == "switch" && !qe && t.doubleIndentSwitch != !1
...
var wi = G(require("@codemirror/language")),
  ...
  fn = class {
    ...
    async setup() {
      this.plugin.registerEditorSuggest(new pn(this.plugin.settings)),
          ...
          token: function (s, l) {
            if ((s.sol() && l.inCommand && (l.freeLine = !0), l.inCommand)) {
              ...
              return (
                s.peek() == null &&
                  l.freeLine &&
                  (p += " line-background-templater-command-bg"),
                l.freeLine || (p += ` line-${mn}`),
                `${p} ${un} ${g}`
              );
            }
